...
<c:if test="${r"${'edit' == msg }"}">
	<div>
		<iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/${objectNameLower}mx/list.do?UUID=${r"${pd."}UUID${r"}"}" style="margin:0 auto;width:805px;height:368px;;"></iframe>
	</div>
</c:if>
