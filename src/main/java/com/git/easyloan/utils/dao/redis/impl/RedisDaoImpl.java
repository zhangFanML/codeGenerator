package com.git.easyloan.utils.dao.redis.impl;
//
//import javacommon.coreframe.dao.AbstractBaseRedisDao;
//import javacommon.coreframe.dao.redis.RedisDao;
//import javacommon.coreframe.util.Db;
...
//	/**删除
//	 * (non-Javadoc)
//	 * @see javacommon.coreframe.dao.redis.RedisDao#delete(String)
//	 */
//	@Override
...
//	/**删除多个
//	 * (non-Javadoc)
//	 * @see javacommon.coreframe.dao.redis.RedisDao#delete(List)
//	 */
//	@Override
...
//	/**修改
//	 * (non-Javadoc)
//	 * @see javacommon.coreframe.dao.redis.RedisDao#eidt(String, String)
//	 */
//	@Override
...
//	/**通过key获取值
//	 * (non-Javadoc)
//	 * @see javacommon.coreframe.dao.redis.RedisDao#get(String)
//	 */
//	@Override
...
//		InputStream inputStream = Db.class.getClassLoader().getResourceAsStream("redis.properties");
