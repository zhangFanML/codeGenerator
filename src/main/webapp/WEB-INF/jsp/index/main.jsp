...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
		...
		<!--引入弹窗组件2start-->
		<script src="static/attention/drag/drag.js"></script>
		<script src="static/attention/drag/dialog.js"></script>
		<link type="text/css" rel="stylesheet" href="static/attention/drag/style.css"  />
		<!--引入弹窗组件2end-->
